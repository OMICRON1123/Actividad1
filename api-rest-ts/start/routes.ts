...
Route.group(() => {
  ...
  Route.get('/listar-usuarios-grupos','UsuariosController.getListarUsuarioGrupos')
  Route.get('/buscar-usuario/:id','UsuariosController.buscarPorId')
  ...
  Route.put('/modificar-usuario/:id','UsuariosController.actualizarUsuario')
